...
public class SelectionButton extends JButton {
	 ...
	 * 
	 * @param file
	 *            a String giving the base location of the Button-Image-file
	 * @param fileOver
	 *            a String giving the base location of the
	 *            Mouse-Over-Button-Image-file
	 */
	 ...
	 * 
	 * @param file
	 *            a URL giving the base location of the Button-Image-file
	 * @param fileOver
	 *            a URL giving the base location of the
	 *            Mouse-Over-Button-Image-file
	 */
