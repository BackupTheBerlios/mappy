...
public class IOHandler implements SettingsIF, LayersIF {
	...
	static String[] getSavedDbSettings() {
		...
		if (path.exists()) {
			try {
				...
				System.err
						.println("Failed to load database settings, using default settings");
				return DB_SETTINGS;
			} catch (ClassNotFoundException e) {
				System.err
						.println("Failed to load database settings, using default settings");
	...
	static boolean getSavedSoundSettings() {
		...
		if (path.exists()) {
			try {
				...
				System.err
						.println("Failed to load soundSettings. Sounds enabled");
				return false;
			} catch (ClassNotFoundException e) {
				System.err
						.println("Failed to load soundSettings. Sounds enabled");
	 ...
	 * 
	 * @param startPoint
	 *            the current upperLeft of the map
	 */
	 ...
	 * 
	 * @param b
	 *            the current Sound Setting (enabled/disabled)
	 */
